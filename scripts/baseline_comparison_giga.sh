#!/bin/sh
python train.py --training_data Aalesund.jpg                    --num_total_prims 2926829 --save_name Aalesund_Gabor --data_device cpu --log_every 0 --log_image_every 0
python train.py --training_data DenmanProspect.jpg              --num_total_prims 2926829 --save_name DenmanProspect_Gabor --data_device cpu --log_every 0 --log_image_every 0
python train.py --training_data MtCook.jpg                      --num_total_prims 2926829 --save_name MtCook_Gabor --data_device cpu --log_every 0 --log_image_every 0
python train.py --training_data Norway.jpg                      --num_total_prims 2926829 --save_name Norway_Gabor --data_device cpu --log_every 0 --log_image_every 0
python train.py --training_data Vermont.jpg                     --num_total_prims 2926829 --save_name Vermont_Gabor --data_device cpu  --log_every 0 --log_image_every 0
python train.py --training_data tokyo_gigapixel.jpg             --num_total_prims 2926829 --save_name Tokyo_Gabor --data_device cpu --log_every 0 --log_image_every 0
python train.py --training_data pluto.png                       --num_total_prims 2926829 --save_name Pluto_Gabor --log_every 0 --log_image_every 0
python train.py --training_data lighthouse.jpg                  --num_total_prims 2926829 --save_name Lighthouse_Gabor --log_every 0 --log_image_every 0
python train.py --training_data girlwithpearlearring_giga.jpg   --num_total_prims 2926829 --save_name GirlWithPearlEarring_Gabor --log_every 0 --log_image_every 0
python train.py --training_data TapestryofBlazingStarbirth.jpg  --num_total_prims 2926829 --save_name Starbirth_Gabor --log_every 0 --log_image_every 0

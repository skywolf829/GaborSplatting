...
class Options():
    def get_default():
        ...
        opt['max_frequency']                        = 64       # 64 best 
        opt['num_frequencies']                      = 2        # 2 best    # REQUIRES RECOMPILATION OF CUDA CODE
        opt['num_total_frequencies']                = 16       # 16 best  # REQUIRES RECOMPILATION OF CUDA CODE
